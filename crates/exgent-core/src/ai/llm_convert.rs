...
use super::{ChatMessage, MessageRole, Model, ToolArguments, ToolCall};
...
fn image_data_url(image: &super::ImageContent) -> String {
...
mod tests {
    ...
    fn converts_user_images_for_provider_payloads() {
        let messages = vec![ChatMessage::user_with_images(
            "describe",
            vec![crate::ai::ImageContent::new("AAAA", "image/png")],
        )];
