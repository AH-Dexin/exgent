...
pub(super) fn en(id: MessageId) -> &'static str {
    match id {
        ...
        MessageId::CmdSettingsTuiDescription => "Tune TUI performance",
        ...
        MessageId::DialogTuiSettings => "TUI Settings",
...
pub(super) fn zh_hans(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::CmdSettingsTuiDescription => "调整 TUI 性能",
        ...
        MessageId::DialogTuiSettings => "TUI 设置",
