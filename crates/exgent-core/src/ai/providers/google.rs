...
fn google_generate_content_stream(
    ...
    let mut request_builder = super::super::shared_blocking_client()
        .post(url)
...
impl GooglePart {
    ...
    fn image(image: &super::super::ImageContent) -> Self {
        Self {
            text: None,
...
mod tests {
    use super::*;
    use crate::ai::{ChatMessage, Model, ProviderEvent, ProviderRequest, ToolCall};
